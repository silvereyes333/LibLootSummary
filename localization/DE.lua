...
local strings = {
    ...
    ["SI_LLS_ICON_SIZE"]                       = "Abbilder Grösse Gegenstände",
    ["SI_LLS_ICON_SIZE_TOOLTIP"]               = "Bestimme die Grösse des Abbildes in Prozent.",
    ...
    ["SI_LLS_COMBINE_DUPLICATES_TOOLTIP"]      = "Links, die mehr als einmal in der Zusammenfassung vorkommen, werden zu einem einzigen Link zusammengefasst und ihre Anzahl wird summiert.",
    ["SI_LLS_SHOW_ITEM_NOT_COLLECTED"]         = "<<1>> Abbilder Sammlung",
    ["SI_LLS_SHOW_ITEM_NOT_COLLECTED_TOOLTIP"] = "Zeigt hinter dem Namen ein Abbild, wenn der Gegenstand noch nicht gesammelt ist.",
    ["SI_LLS_SHOW_LOOT_NOT_COLLECTED"]         = "<<1>> Abbilder Sammlung",
    ...
    ["SI_LLS_SORT_ORDER_TOOLTIP"]              = "Wählen Sie aus, wie die Zusammenfassung sortiert werden soll.",
    ["SI_LLS_DELIMITER"]                       = "Listentrennzeichens",
    ["SI_LLS_DELIMITER_TOOLTIP"]               = "Wählen Sie aus, welche Zeichen Einträge in der Zusammenfassung trennen. „\\n“ bedeutet, dass alle Listeneinträge in separaten Zeilen angezeigt werden.",
    ["SI_LLS_LINK_STYLE"]                      = "Link-Erscheinungsbild",
    ["SI_LLS_LINK_STYLE_TOOLTIP"]              = "Wählen Sie aus, wie Links in der Zusammenfassung angezeigt werden sollen.",
}
