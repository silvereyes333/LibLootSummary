...
local strings = {
    ...
    ["SI_LLS_ICON_SIZE_TOOLTIP"]               = "Utilisez un pourcentage pour spécifier la taille des icônes qui apparaissent dans le récapitulatif.",
    ...
    ["SI_LLS_SHOW_ITEM_NOT_COLLECTED_TOOLTIP"] = "Affichez les icônes à droite des noms d'objets si leurs pièces de set ne sont pas collectées.",
    ["SI_LLS_SHOW_LOOT_NOT_COLLECTED"]         = "<<1>> Icônes des pièces d'ensembles non collectés",
    ["SI_LLS_SHOW_LOOT_NOT_COLLECTED_TOOLTIP"] = "Affichez les icônes à droite des noms du butin si leurs pièces de set ne sont pas collectées.",
